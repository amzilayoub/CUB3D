...
/*   Updated: 2020/02/16 23:21:45 by aamzil           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    treat_sprites()
{
    ...
    {    
        ...
        g_sprites[i].angle = atan2(-g_player.y + (g_sprites[i].y * g_box_size),
                                -g_player.x + (g_sprites[i].x * g_box_size));
        ...
        if (g_file_info.win_width >= g_file_info.win_height)
            g_sprites[i].size = (g_file_info.win_width / g_sprites[i].dist * 64);
        else
            g_sprites[i].size = (g_file_info.win_height / g_sprites[i].dist * 64);
